...
function Sections() {
  ...
  useEffect(() => {
    axios
      .get(api + `5001/api/sec?page=1&limit=${rowsPerPage}`)
      .then(({ data }) => {
        setTimeout(() => {
          toast.dark(history.location.state?.data);
        }, [500]);
        console.log(data.data);
        setSections(data.data || data.result?.results);
      })
      .catch((e) => {
        console.log(e);
      });
  ...
  function handleSelectAllClick(event) {
    if (event.target.checked) {
      setSelected(sections.map((n) => n._id));
      return;
    }
    setSelected([]);
  }
            ...
            <div className="flex flex-1 flex-col items-center justify-center md:flex-row md:items-center md:justify-start">
              ...
              <div className="flex items-center justify-end">
                ...
                <Button
                  ...
                  variant="contained"
                  onClick={() => {
                    history.push("/academics/sections_create");
                  }}
                  aria-label="Follow"
                >
                  Create new section
                  ...
                  .map((n, i) => {
                    ...
                    return (
                      <TableRow
                        ...
                        selected={isSelected}
                        onClick={() =>
                          history.push("/academics/sections_edit/" + n._id)
                        }
                      >
                        <TableCell
                        ...
                        <TableCell
                          ...
                          scope="row"
                        >
                          {n.is_active === 1 ? "In active" : "active"}
                        </TableCell>
