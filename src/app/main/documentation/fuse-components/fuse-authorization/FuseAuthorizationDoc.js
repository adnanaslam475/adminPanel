      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            ...
            Fuse React. It restricts the unauthorized user access with looking{" "}
          ...
          <Typography className="mb-16" component="p">
            ...
            <b>route config files</b> for to control the access via permission
            roles.
          </Typography>
          ...
          <Typography className="mb-16" component="p">
            User <b>role</b> and <b>data</b> are stored at <b>auth.user</b> in
            the redux store.
          </Typography>
          ...
          <FuseHighlight component="pre" className="language-js">
            {`  
                              const initialState = {
                                role: [],//guest
                                data: {
                                    'displayName': 'BNCollege',
                                    'photoURL'   : 'assets/images/avatars/Velazquez.jpg',
                                    'email'      : 'bncollege@example.com',
                                    shortcuts    : [
                                        'calendar',
                                        'mail',
                                        'contacts',
          ...
          <Paper className="max-w-md my-16">
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell>
                    <code>null</code> or <code>undefined</code> or{" "}
                    <code>[]</code>
                  </TableCell>
          ...
          <Typography className="mb-16" component="p">
            You can control the navigation <b>item/group/collapse</b> visibility
            by adding <b>auth</b> property in
          ...
          <Typography className="mt-48 mb-4" variant="h6">
            On routesConfig.js file:
          </Typography>
          <Typography className="mb-12" variant="subtitle2">
            (Making the whole app auth protected)
          </Typography>

          <Typography className="mb-16" component="p">
            If you don't want to set auth on every page config;
            <br />
            You can group the configs and define authorization in the{" "}
            <code>src/app/fuse-configs/routesConfig.js</code> file,
            <br />
            With this configuration below, makes <b>whole app</b> auth
            protected:
          </Typography>
          <FuseHighlight component="pre" className="language-js">
            {`
